...
String formatBytes(List<int> bytes) {
  final StringBuffer sb = StringBuffer('<int>[\n');
...
void main() {
  print('// ── safe area bytes ──');
  print('const List<int> _safeAreaBytes = ${formatBytes(mask(kSafeArea))};');
  print('');
  print('// ── keyboard bytes ──');
  print('const List<int> _keyboardBytes = ${formatBytes(mask(kKeyboard))};');
}
